...
// GraphDrawing.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGraphDrawingApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CGraphDrawingApp

CGraphDrawingApp::CGraphDrawingApp()
{
...
// Единственный объект CGraphDrawingApp

CGraphDrawingApp theApp;


// Инициализация CGraphDrawingApp

BOOL CGraphDrawingApp::InitInstance()
{
